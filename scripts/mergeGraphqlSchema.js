...
function mergeSchema(appName) {
    ...
    var amplifySchema = (0, graphql_1.parse)((0, fs_1.readFileSync)((0, path_1.join)(process.cwd(), "cdk/lib/amplify-export-".concat(appName, "/api/").concat(appName, "/amplify-appsync-files/schema.graphql")), 'utf8'));
    // Merge the schemas
    ...
    var outputFile = (0, path_1.join)(process.cwd(), "cdk/lib/amplify-export-".concat(appName, "/api/").concat(appName, "/amplify-appsync-files/schema.graphql"));
